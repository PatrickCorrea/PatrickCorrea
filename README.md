...
<p> Meu nome é Patrick Jorge , FullStack Developer e especializado em desenvolvimento de soluções digitais escaláveis ​​e de alta performance. Experiência com Node.js, React.js, Next.js, TypeScript e Docker, aplicando boas práticas de arquitetura de software. COm foco em inovação, automação e entrega de resultados reais para o negócio.

Atuo na construção de sistemas completos, integrando front-end, back-end e infraestrutura, com ênfase em qualidade, escalabilidade e usabilidade. <p/>
